...
### Features
- First release version. Includes all features and fixes from pre-release versions of v0.1.0.
- Implemented auto band mode for OV3660 sensor.
- Adjusted values for JPEG frame allocation size.
- All examples now use the release version as dependencies by default.
