...
static const esp_cam_sensor_io_parl_ratio_settings_t ratio_table[] = {
    ...
    { 2592, 1944,   0,   0, 2623, 1951, 16, 4, 2844, 1966 }, //4x3
    { 2560, 1704,   0, 110, 2623, 1841, 16, 4, 2844, 1752 }, //3x2
    { 2560, 1600,   0, 160, 2623, 1791, 16, 4, 2844, 1648 }, //16x10
    { 2560, 1536,   0, 192, 2623, 1759, 16, 4, 2844, 1584 }, //5x3
    { 2560, 1440,   0, 240, 2623, 1711, 16, 4, 2844, 1488 }, //16x9
    { 2560, 1080,   0, 420, 2623, 1531, 16, 4, 2844, 1128 }, //21x9
    { 2400, 1920,  80,   0, 2543, 1951, 16, 4, 2684, 1966 }, //5x4
    { 1920, 1920, 320,   0, 2543, 1951, 16, 4, 2684, 1966 }, //1x1
    { 1088, 1920, 736,   0, 1887, 1951, 16, 4, 1884, 1966 }  //9x16
};
...
static const DRAM_ATTR uint16_t sensor_default_regs[][2] = {
    ...
    {CLOCK_POL_CONTROL, 0x2c},

    {0x4713, 0x02},//jpg mode select
    //{0x4400, 0x81}, // YUV420 input?
    {0x4404, 0x34},
    //{0x4602, 0x03},
    //{0x4603, 0x00},
    //{0x4604, 0x02},
